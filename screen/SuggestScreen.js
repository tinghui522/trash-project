...
export default function SuggestScreen({ navigation }) {
  const [state, setState] = useState({selectedTab: 'trash'});

  return (
    <ScrollView>
      <Animated.View style={{ height: 1380, opacity: Animated.add(0.3, Animated.multiply(fall, 0.8)) }}>
      <View>
        ...
        <View style={{ marginTop: 90}}>
          <TabNavigator tabBarStyle={styles.tab}>
            <TabNavigator.Item
              selected={state.selectedTab === 'trash'}
              ...
              onPress={() => setState({ selectedTab: 'trash' })}>
            ...
            <TabNavigator.Item
              ...
              onPress={() => setState({ selectedTab: 'money' })}>
              <View style={styles.container}>
                <View style={styles.chart}>
