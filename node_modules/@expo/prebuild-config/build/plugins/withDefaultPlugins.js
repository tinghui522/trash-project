...
exports.withExpoLegacyPlugins = exports.getExpoLegacyPlugins = exports.withExpoVersionedSDKPlugins = exports.withExpoAndroidPlugins = exports.withExpoIOSPlugins = void 0;
/**
...
const withExpoIOSPlugins = (config, { bundleIdentifier }) => {
    ...
    return config_plugins_1.withPlugins(config, [
        ...
        config_plugins_1.IOSConfig.UserInterfaceStyle.withUserInterfaceStyle,
...
const withExpoAndroidPlugins = (config, props) => {
    ...
    return config_plugins_1.withPlugins(config, [
        ...
        // AndroidManifest.xml
        config_plugins_1.AndroidConfig.Package.withPackageManifest,
        ...
        config_plugins_1.AndroidConfig.UserInterfaceStyle.withUiModeManifest,
        // MainActivity.*
        config_plugins_1.AndroidConfig.UserInterfaceStyle.withUiModeMainActivity,
        // strings.xml
        ...
        config_plugins_1.AndroidConfig.RootViewBackgroundColor.withRootViewBackgroundColor,
        config_plugins_1.AndroidConfig.NavigationBar.withNavigationBar,
        config_plugins_1.AndroidConfig.StatusBar.withStatusBar,
        config_plugins_1.AndroidConfig.PrimaryColor.withPrimaryColor,
        c => withAndroidIcons_1.withAndroidIcons(c),
...
function getExpoLegacyPlugins() {
    return expoLegacyPlugins;
}
exports.getExpoLegacyPlugins = getExpoLegacyPlugins;
...
const withOptionalLegacyPlugins = (config, plugins) => {
    return plugins.reduce((prev, plugin) => {
        return config_plugins_1.withStaticPlugin(prev, {
            // hide errors
