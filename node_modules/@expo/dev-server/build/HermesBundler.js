...
exports.getHermesBytecodeBundleVersionAsync = exports.isHermesBytecodeBundleAsync = exports.parseGradleProperties = exports.createHermesSourcemapAsync = exports.buildHermesBundleAsync = exports.shouldBuildHermesBundleAsync = void 0;
...
async function shouldBuildHermesBundleAsync(projectRoot, platform) {
    if (platform === 'android') {
        ...
        const properties = parseGradleProperties(await fs_extra_1.default.readFile(gradlePropertiesPath, 'utf8'));
...
exports.shouldBuildHermesBundleAsync = shouldBuildHermesBundleAsync;
