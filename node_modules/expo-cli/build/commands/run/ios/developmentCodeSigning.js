...
function getCodeSigningInfoForPbxproj(projectRoot) {
  ...
  const [, nativeTarget] = _configPlugins().IOSConfig.Target.findFirstNativeTarget(project);
...
function setAutoCodeSigningInfoForPbxproj(projectRoot, {
  ...
  const [nativeTargetId, nativeTarget] = _configPlugins().IOSConfig.Target.findFirstNativeTarget(project);
