...
exports.createBundlesAsync = exports.printBundleSizes = void 0;
...
function printBundleSizes(bundles) {
    ...
    internal_1.Logger.global.info('');
    internal_1.Logger.global.info(`💡 JavaScript bundle sizes affect startup time. ${chalk_1.default.dim(internal_1.learnMore(`https://expo.fyi/javascript-bundle-sizes`))}`);
    internal_1.Logger.global.info('');
}
